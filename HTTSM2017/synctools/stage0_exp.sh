...
combineTool.py -M MultiDimFit -m 125 -d output/${ERA}_smhtt/${CHANNEL}/125/${ERA}_workspace.root --algo singles  -t -1 --expectSignal 1 --robustFit 1 -n cmb --X-rtd MINIMIZER_analytic --cminDefaultMinimizerStrategy 0
