...
combine -M Significance -t -1 --expectSignal 1 --X-rtd MINIMIZER_analytic --cminDefaultMinimizerStrategy 0 --significance -m 125 -n $ERA --toysFrequentist output/${ERA}_smhtt/${CHANNEL}/125/${ERA}_workspace.root
