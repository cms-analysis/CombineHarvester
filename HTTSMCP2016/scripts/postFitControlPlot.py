...
background_schemes = {'mt':[backgroundComp("Electroweak",["VVT"],ROOT.TColor.GetColor(222,90,106)),backgroundComp("t#bar{t}",["TTT"],ROOT.TColor.GetColor(155,152,204)),backgroundComp("Z#rightarrow#mu#mu",["ZL","EWKZ"],ROOT.TColor.GetColor(100,192,232)),backgroundComp("jet#rightarrow#tau_{h} fakes",["jetFakes"],ROOT.TColor.GetColor(192,232,100)),backgroundComp("#mu#rightarrow#tau embedding",["EmbedZTT"],ROOT.TColor.GetColor(248,206,104))],
'et':[backgroundComp("Electroweak",["VVT"],ROOT.TColor.GetColor(222,90,106)),backgroundComp("t#bar{t}",["TTT"],ROOT.TColor.GetColor(155,152,204)),backgroundComp("Z#rightarrowee",["ZL","EWKZ"],ROOT.TColor.GetColor(100,192,232)),backgroundComp("jet#rightarrow#tau_{h} fakes",["jetFakes"],ROOT.TColor.GetColor(192,232,100)),backgroundComp("#mu#rightarrow#tau embedding",["EmbedZTT"],ROOT.TColor.GetColor(248,206,104))],
'tt':[backgroundComp("l#rightarrow#tau_{h} fakes",["VVT","ZL","EWKZ","TTT"],ROOT.TColor.GetColor(100,192,232)),backgroundComp("jet#rightarrow#tau_{h} fakes",["jetFakes"],ROOT.TColor.GetColor(192,232,100)),backgroundComp("#mu#rightarrow#tau embedding",["EmbedZTT"],ROOT.TColor.GetColor(248,206,104))],
#'em':[backgroundComp(backgroundComp("Electroweak",["VVT"],ROOT.TColor.GetColor(222,90,106)),backgroundComp("t#bar{t}",["TTT"],ROOT.TColor.GetColor(155,152,204)),backgroundComp("Z#rightarrowll",["ZLL","EWKZ"],ROOT.TColor.GetColor(100,192,232)),backgroundComp("#mu#rightarrow#tau embedding",["EmbedZTT"],ROOT.TColor.GetColor(248,206,104))],
'em':[backgroundComp("Electroweak",["VV","W","ZLL","EWKZ"],ROOT.TColor.GetColor(222,90,106)),backgroundComp("t#bar{t}",["TT"],ROOT.TColor.GetColor(155,152,204)),backgroundComp("QCD", ["QCD"], ROOT.TColor.GetColor(250,202,255)),backgroundComp("#mu#rightarrow#tau embedding",["EmbedZTT"],ROOT.TColor.GetColor(248,206,104))]}

if args.tauidplot:
  background_schemes['mt'] = [backgroundComp("t#bar{t}",["TTT","TTJ"],ROOT.TColor.GetColor(155,152,204)),backgroundComp("QCD", ["QCD"], ROOT.TColor.GetColor(250,202,255)),backgroundComp("Electroweak",["VVT","VVJ","W"],ROOT.TColor.GetColor(222,90,106)),backgroundComp("Z#rightarrow#mu#mu",["ZL","ZJ"],ROOT.TColor.GetColor(100,192,232)),backgroundComp("Z#rightarrow#tau#tau",["ZTTpass","ZTTfail","EmbedZTT_pass","EmbedZTT_fail"],ROOT.TColor.GetColor(248,206,104))]
...
if args.ratio and not fractions:
  ...
  if not soverb_plot: axish[1].GetYaxis().SetTitle("Data/Exp")
  ...
  axish[0].GetYaxis().SetTitleOffset(1.7)
...
if outname == '':  outname = shape_file_name
