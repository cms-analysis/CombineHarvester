...
combine -M MultiDimFit -m 125 --algo grid --points 20 --rMin 0.001 --rMax 3 cmb/125/workspace.root -n nominal -t -1 --expectSignal=1
combine -M MultiDimFit --algo none --rMin 0.001 --rMax 3 cmb/125/workspace.root -m 125 -t -1 --expectSignal=1 -n bestfit --saveWorkspace
...
combine -M MultiDimFit --algo grid --points 20 --rMin 0.001 --rMax 3 -m 125 -t -1 --expectSignal=1 -n stat \
...
combine -M MultiDimFit --algo grid --points 20 --rMin 0.001 --rMax 3 -m 125 -t -1 --expectSignal=1 -n theory \
