...
ALGO=AD
combineTool.py -M GoodnessOfFit --algorithm $ALGO -m 125 --there -d cmb/125/workspace.root -n ".$ALGO.toys" --fixedSignalStrength=1 -t 5 -s 0:10:1 --parallel 12
...
for CHANNEL in em et mt tt; do
    for BIN in 1 2 3; do
        ...
        combineTool.py -M GoodnessOfFit --algorithm $ALGO -m 125 --there -d htt_${CHANNEL}_${BIN}_13TeV/125/workspace_${CHANNEL}_${BIN}.root -n ".$ALGO.toys" --fixedSignalStrength=1 -t 5 -s 0:10:1 --parallel 12
