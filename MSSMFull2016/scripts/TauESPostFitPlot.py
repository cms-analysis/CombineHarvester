...
def getHistogram(fname,histname,postfitmode='prefit'):
  ...
  for key in fname.GetListOfKeys():
    ...
    if isinstance(histo,ROOT.TH1F) and key.GetName()==histname:
      ...
      return getHistogram(histo,histname,postfitmode)
...
parser.add_argument('--r',default='0.1',help='Signal XS*BR to scale ZTT')
...
parser.add_argument('--x_axis_min',  help='Fix x axis minimum', default=70.0)
parser.add_argument('--x_axis_max',  help='Fix x axis maximum', default=140.0)
