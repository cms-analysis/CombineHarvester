...
/*  cb.cp().process({"TTH_SM125"}).AddSyst(cb, "pdf_Higgs_ttH","lnN",
  ...
  //MSSM bbH theory uncertainties (NLO only)
  
  cb.cp().process(bbH).AddSyst(cb, "QCDScale_bbH","lnN", SystMap<channel,bin_id,mass>::init 
     ({"mt"}, {8}, {"130"}, 0.97)
     ({"mt"}, {9}, {"130"}, 1.05)
     ({"mt"}, {10}, {"130"}, 0.95)
     ({"mt"}, {11}, {"130"}, 0.69)
  ...
  cb.cp().process(bbH).AddSyst(cb, "Qsh_bbH","lnN", SystMap<channel,bin_id,mass>::init
     ({"et","mt","tt"}, {8,10}, {"130"}, 1.03)
     ({"et","mt","tt"}, {9,11}, {"130"}, 0.91)
     ({"et","mt","tt"}, {8,10}, {"200"}, 1.03)
     ({"et","mt","tt"}, {9,11}, {"200"}, 0.92) 
     ({"et","mt","tt"}, {8,10}, {"350"}, 1.03)
     ({"et","mt","tt"}, {9,11}, {"350"}, 0.93)
     ({"et","mt","tt"}, {8,10}, {"700"}, 1.03)
     ({"et","mt","tt"}, {9,11}, {"700"}, 0.96)
     ({"et","mt","tt"}, {8,10}, {"1200"}, 1.02)
     ({"et","mt","tt"}, {9,11}, {"1200"}, 0.98)
     ({"et","mt","tt"}, {8,10}, {"1800"}, 1.02)
     ({"et","mt","tt"}, {9,11}, {"1800"}, 0.98)
     ({"et","mt","tt"}, {8,10}, {"3200"}, 1.01)
     ({"et","mt","tt"}, {9,11}, {"3200"}, 0.98));
