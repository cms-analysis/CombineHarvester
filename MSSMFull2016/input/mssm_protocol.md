...
`MorphingMSSMFull2016 --output_folder="mssm_120717" -m MH --auto_rebin=true`
...
**MSSMvsBkg**
`MorphingMSSMFull2016 --output_folder="mssm_070617_mhmodp" --auto_rebin=true`
...
MorphingMSSMFull2016 --output_folder="mssm_070617_MSSMvsSM_mhmodp" --auto_rebin=true -h "signal_SM125"
...
MorphingMSSMFull2016 --output_folder="mssm_070617_SMHbkg" -m MH --manual_rebin=true -h "bkg_SM125"
...
combineTool.py -M T2W -o "ws.root" -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel --PO '"map=^.*/ggH$:r_ggH[0,0,200]"' --PO '"map=^.*/bbH$:r_bbH[0,0,200]"' -i output/mssm_120717/*

combineTool.py -M T2W -o "ws.root" -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel --PO '"map=^.*/ggH$:r_ggH[0,0,200]"' --PO '"map=^.*/bbH$:r_bbH[0,0,200]"' -i output/mssm_120717_NLO/*
...
combineTool.py -M T2W -o "mhmodp.root" -P CombineHarvester.CombinePdfs.MSSM:MSSM --PO filePrefix=$PWD/shapes/Models/ --PO modelFiles=13TeV,mhmodp_mu200_13TeV.root,1 [--PO debugOutput="mhmodp_mu200_13TeV_debug.root" --PO makePlots ] -i output/mssm_070617_mhmodp/*
...
combineTool.py -m "90,100,110,120,130,140,160,180,200,250,350,400,450,500,600,700,800,900,1000,1200,1400,1600,1800,2000,2300,2600,2900,3200" -t -1 -M Asymptotic --rAbsAcc 0 --rRelAcc 0.0005 --boundlist input/mssm_boundaries.json  --setPhysicsModelParameters r_ggH=0,r_bbH=0 --redefineSignalPOIs r_ggH -d output/mssm_120717/*/ws.root --there -n ".ggH"

combineTool.py -m "130,200,350,700,1200,1800,3200" -t -1 -M Asymptotic --rAbsAcc 0 --rRelAcc 0.0005 --boundlist input/mssm_boundaries.json  --setPhysicsModelParameters r_ggH=0,r_bbH=0 --redefineSignalPOIs r_bbH -d output/mssm_120717_NLO/*/ws.root --there -n ".bbH"

[combineTool.py -m "90,100,110,120,130,140,160,180,200,250,350,400,450,500,600,700,800,900,1000,1200,1400,1600,1800,2000,2300,2600,2900,3200" -t -1 -M Asymptotic --rAbsAcc 0 --rRelAcc 0.0005 --boundlist input/mssm_boundaries.json  --setPhysicsModelParameters r_ggH=0,r_bbH=0 --redefineSignalPOIs r_bbH -d output/mssm_070617/*/ws.root --there -n ".bbH"]

This goes to each subdirectory of output/mssm_120717[_NLO]/ (--there) and performs the combine calculation for the masses listed on the workspace (either ggH or bbH workspace). The combine output files are stored in the directories alongside the datacards. Note the optin --parallel = X allows you to run the calculations interactively with X in parallel, and e.g.' --job-mode 'lxbatch' --task-name 'mssm_ggH' --sub-opts '-q 1nh' --merge=4 ' could be used to instead run on the lxbatch, merging 4 masspoints into 1 job and submitting to the 1 hour queue.

Once all calculations are complete, the results are collected into json files using:

combineTool.py -M CollectLimits output/mssm_120717/*/higgsCombine.ggH*.root --use-dirs -o "mssm_120717_ggH.json"

combineTool.py -M CollectLimits output/mssm_120717_NLO/*/higgsCombine.bbH*.root --use-dirs -o "mssm_120717_bbH.json"

This will place a json in the current directory, and append the string "mssm_120717_ggH" to them. One will be placed for every subdir, so every channel-cat, combination requested will be available then for plotting.
...
combineTool.py -M AsymptoticGrid ./scripts/mssm_asymptotic_grid.json -d output/mssm_070617_mhmodp/cmb/mhmodp.root  --job-mode 'interactive' --task-name 'mssm_mhmodp'
...
combineTool.py -M HybridNewGrid ./scripts/mssm_hybrid_grid_mhmodp.json --cycles 2 -d output/mssm_070617_mhmodp/cmb/mhmodp.root  --job-mode 'crab3' --task-name 'mssm_mhmodp_hybridgrid' --crab-area 'Jun7_Combine'
...
3d) Running ggH-bbH 2D limits (Asymptotic)

The 2D limits are run using combineTool to take advantage of the possibilty to run for multiple masses and submission.

combineTool.py -m "90,100,110,120,130,140,160,180,200,250,350,400,450,500,600,700,800,900,1000,1200,1400,1600,1800,2000,2300,2600,2900,3200" -M MultiDimFit --boundlist input/mssm_ggH_bbH_2D_boundaries.json --setPhysicsModelParameters r_ggH=0,r_bbH=0 --redefineSignalPOIs r_ggH,r_bbH -d output/mssm_0706/cmb/ws.root --there -n ".ggH-bbH" --points 500 --algo grid
...
combineTool.py -m "125" -M MultiDimFit --boundlist input/mssm_ggH_bbH_2D_boundaries.json --setPhysicsModelParameters r_ggH=0,r_bbH=0 --redefineSignalPOI r_ggH,r_bbH -t -1 -d output/mssm_070617_SMHbkg/cmb/ws.root --there -n ".2D.ToyDataset.SM1" --algo none --saveToys
...
cp output/mssm_070617_SMHbkg/cmb/higgsCombine.2D.ToyDataset.SM1.MultiDimFit.mH125.123456.root output/mssm_070617/cmb/higgsCombine.2D.ToyDataset.SM1.MultiDimFit.mH125.123456.root

combineTool.py -m "90,100,110,120,130,140,160,180,200,250,350,400,450,500,600,700,800,900,1000,1200,1400,1600,1800,2000,2300,2600,2900,3200" -M MultiDimFit --boundlist input/mssm_ggH_bbH_2D_boundaries.json --setPhysicsModelParameters r_ggH=0,r_bbH=0 --redefineSignalPOI r_ggH,r_bbH -t -1 -d output/mssm_070617/cmb/ws.root --there -n ".2D.SM1.bestfit" --algo none --toysFile higgsCombine.2D.ToyDataset.SM1.MultiDimFit.mH125.123456.root

3e) Running ggH-bbH 2D limits (Feldman-Cousins)
...
combineTool.py -M HybridNewGrid ./scripts/mssm_hybrid_grid_FCInterval.json --cycles 2 -d output/mssm_1207/cmb/ws.root  --job-mode 'crab3' --task-name 'mssm_FCIntervals700' --crab-area 'Jul27_Combine'
...
combineTool.py -M HybridNewGrid /FULL/PATH/TO/CH/AREA/scripts/mssm_hybrid_grid_FCInterval.json --cycles 0 -d /FULL/PATH/TO/CH/AREA/output/mssm_1207/cmb/ws.root  --output

*notes*
- Make sure the crab storage site is set correctly. This can be done e.g by creating a python file like CombineTools/scripts/custom_crab.py and adding, to the combineTool.py call
above, --custom-crab ../CombineTools/scripts/custom_crab.py 
...
combineTool.py -m "700" -M MultiDimFit --boundlist input/mssm_ggH_bbH_2D_boundaries.json --setPhysicsModelParameters r_ggH=0,r_bbH=0 --redefineSignalPOIs r_ggH,r_bbH -d output/mssm_1207/cmb/ws.root --there -n ".ggH-bbH-bestfit" 

3f) Running model independent limits with signal injected (blue band) - not been used for a long time, seek advice before trying this
...
combineTool.py -m 160 -M GenerateOnly --setPhysicsModelParameters r_ggH=0,r_bbH=0,r_SM=1 --freezeNuisances r_SM --redefineSignalPOI r_ggH,r_bbH -t -1 --toysFrequentist -d output/mssm_070617_withSM/cmb/ws_SM_and_MSSM.root --there -n ".InitalFit" --saveWorkspace

Based on this snapshot (it is called clean) the toys can then be generated.

combineTool.py -m "160"  -M GenerateOnly --setPhysicsModelParameters r_ggH=0,r_bbH=0 --snapshot clean --freezeNuisances r_SM --rerefineSignalPOI r_ggH,r_bbH -t 50 -d output/mssm_070617_withSM/cmb/higgsCombine.InitalFit.GenerateOnly.mH160.root --there -n ".Toys" -s 0 --saveToys
...
combineTool.py -M CollectLimits output/mssm_070617_withSM/cmb/higgsCombine.ggH.*.root --use-dirs -o "mssm_070617_BlueBand_ggH.json"
combineTool.py -M CollectLimits output/mssm_070617_withSM/cmb/higgsCombine.bbH.*.root --use-dirs -o "mssm_070617_BlueBand_bbH.json"

4a) Plotting model independent limits

The usual Brazil band plots can be made using this script, for e.g. the mutau channel:

python scripts/plotMSSMLimits.py --logy --logx mssm_120717_ggH_mt.json --cms-sub="Preliminary" -o mssm_120717_mt --process 'gg#phi' --title-right="35.9 fb^{-1}" --title-left="#mu#tau_{h}" --show 'exp' --plot-exp-points

Or comparison plots can be made using the following script:

python scripts/MSSMlimitCompare.py --file=mssm_070617_ggH_mt.json,mssm_070617_ggH_et.json --labels="mutau,etau" --expected_only --outname="mssm_070617_freezing_mt_vs_et_ggH" --process="gg#phi" 
...
python scripts/plotMSSMLimits.py --logy --logx mssm_freezing_withSMBG_ggH_mt.json --cms-sub="Preliminary" -o mssm_070617_SMHbg_mt --higgs-bg

4b) Making limit comparisons for sync purposes:
...
4c) Plotting model dependent limits
...
python scripts/plotMultiDimFit.py --title-right="35.9 fb^{-1} (13 TeV)" --cms-sub="Preliminary" --mass $MASS -o 2D_limit_mH${MASS} output/mssm_070617/cmb/higgsCombine.ggH-bbH.MultiDimFit.mH${MASS}.root
...
python scripts/plotMultiDimFit.py --title-right="35.9 fb^{-1} (13 TeV)" --cms-sub="Preliminary" --mass $MASS -o 2D_limit_mH${MASS} output/mssm_070617/cmb/higgsCombine.ggH-bbH.MultiDimFit.mH${MASS}.root --sm-exp output/mssm_070617/cmb/higgsCombine.2D.SM1.bestfit.MultiDimFiti.mH${MASS}.root

4f) Plotting ggH-bbH 2D limits (from HybridNewGrid output)

python scripts/plotFCIntervals.py HybridNewGridFCInterval.root --output="2D_limit_FC_mH${MASS}" --title-right="35.9 fb^{-1} (13 TeV)" --cms-sub="Preliminary" --mass 700 --best-fit output/mssm_1207/cmb/higgsCombine.ggH-bbH-bestfit.MultiDimFit.mH700.root
...
4g) plotting model independent limits with signal injected (blue band)
...
PostFitShapesFromWorkspace -d output/mssm_070617_mhmodp/cmb/combined.txt.cmb -w output/mssm_070617_mhmodp/cmb/mhmodp.root -o shapes_070617.root --print --freeze mA=1000,tanb=50,r=1,x=1
To make the plots in the docs:
python scripts/makeMassPlotsPrefit.py

First is a call to PostFitShapesFromWorkspace, which will generate the signal and background templates for the benchmark point of mA = 1 TeV, tanb=50 in the mhmodp scenario. The postFitPlotJetFakes 
script, which is called from makeMassPlotsPrefit.py will  make a stacked plot. With the current settings the plots are blind above 100 GeV.
...
6) Postfit plots 
Postfit plots require a sensible choice of fit. You can choose either the model independent or model dependent workspace, and simply need to set the appropriate parameters to soemthign sensible.
...
MorphingMSSMFull2016 --output_folder="mssm_120717_unblinding_mhmodp" --postfix="-mttot" --control_region=0 --auto_rebin=true --real_data=true --zmm_fit=true --ttbar_fit=true --jetfakes=true 
...
MorphingMSSMFull2016 --output_folder="mssm_120717_unblinding" -m MH --postfix="-mttot" --control_region=0 --auto_rebin=true --real_data=true --zmm_fit=true --ttbar_fit=true --jetfakes=true 

combineTool.py -M T2W -o "ws.root" -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel --PO '"map=^.*/ggH$:r_ggH[0,0,200]"' --PO '"map=^.*/bbH$:r_bbH[0,0,200]"' -i output/mssm_120717_unblinding/*

---Max likelihood fit (model independent ws)---
combineTool.py -M MaxLikelihoodFit --setPhysicsModelParameters r_ggH=0,r_bbH=0 --freezeNuisances r_bbH --redefineSignalPOIs r_ggH -m 700  --setPhysicsModelParameterRanges r_ggH=-0.000001,0.000001 --minimizerTolerance 0.1 --minimizerStrategy 0 -d output/mssm_120717_unblinding/cmb/ws.root --there

---Get the shapes, including signal shape from the model dependent ws---
PostFitShapesFromWorkspace -d output/mssm_120717_unblinding_mhmodp/cmb/combined.txt.cmb -w output/mssm_120717_unblinding_mhmodp/cmb/mhmodp.root -o shapes.root --print --freeze mA=1000,tanb=50,r=1,x=1 --postfit --sampling -f output/mssm_120717_unblinding/cmb/mlfit.Test.root:fit_b

python scripts/makeMassPlots.py

8) creating datacards for pulls and GOF tests - ALL GOF instructions to be updated
...
combineTool.py -M T2W -o "ws.root" -i output/mssm_120717_unblinding/*
...
combineTool.py -M GoodnessOfFit --algorithm $ALGO -m 160 --there -d output/mssm_120717_unblinding/cmb/ws.root -n ".$ALGO.toys" --fixedSignalStrength=0 -t 500
combineTool.py -M GoodnessOfFit --algorithm $ALGO -m 160 --there -d output/mssm_120717_unblinding/cmb/ws.root -n ".$ALGO" --fixedSignalStrength=0

ALGO=saturated
combineTool.py -M GoodnessOfFit --algorithm $ALGO -m 160 --there -d output/mssm_120717_unblinding/*_13TeV/ws.root -n ".$ALGO.toys" --fixedSignalStrength=0 -t 500
combineTool.py -M GoodnessOfFit --algorithm $ALGO -m 160 --there -d output/mssm_120717_unblinding/*_13TeV/ws.root -n ".$ALGO" --fixedSignalStrength=0
...
combineTool.py -M CollectGoodnessOfFit --input output/mssm_120717_unblinding/htt_et_8_13TeV/higgsCombine.saturated.GoodnessOfFit.mH160.root output/mssm_120717_unblinding/htt_et_8_13TeV/higgsCombine.saturated.toys.GoodnessOfFit.mH160.*.root -o htt_et_8_13TeV_saturated.json

For the AD and KS run

ALGO=AD (or ALGO=KS)
combineTool.py -M CollectGoodnessOfFit --input output/mssm_120717_unblinding/cmb/higgsCombine.$ALGO.GoodnessOfFit.mH160.root output/mssm_071016_unblinding/cmb/higgsCombine.$ALGO.toys.GoodnessOfFit.mH160.*.root -o cmb_$ALGO.json
...
combineTool.py -M MaxLikelihoodFit output/mssm_120717_unblinding/cmb/ws.root

Workaround for not unblinding fitted signal strength: can also set signal to only float within a very small range, e.g:

combine -M MaxLikelihoodFit --setPhysicsModelParameters r_ggH=0,r_bbH=0 --freezeNuisances r_bbH --redefineSignalPOIs r_ggH -m 700  --setPhysicsModelParameterRanges r_ggH=-0.000001,0.000001 --minimizerTolerance 0.1 --minimizerStrategy 0 -d output/mssm_120717_unblinding/cmb/ws.root
...
-First, set up the datacards as in step 1a)

-Create the workspace:
combineTool.py -M T2W -o "ws.root" -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel --PO '"map=^.*/ggH$:r_ggH[0,-1,200]"' --PO '"map=^.*/bbH$:r_bbH[0,-1,200]"' -i output/mssm_070617/*
...
combineTool.py -t -1 -M Impacts -d output/mssm_070617/cmb/ws.root -m $MASS --doInitialFit --robustFit 1 --minimizerAlgoForMinos Minuit2,Migrad --redefineSignalPOIs r_ggH --freezeNuisances r_bbH --setPhysicsModelParameters r_bbH=0,r_ggH=$INJECTED_SIGNAL --setPhysicsModelParameterRanges r_ggH=$RANGE
...
combineTool.py -t -1 -M Impacts -d output/mssm_070617/cmb/ws.root -m 200 --doFits --robustFit 1 --minimizerAlgoForMinos Minuit2,Migrad --redefineSignalPOIs r_ggH --freezeNuisances r_bbH --setPhysicsModelParameters r_bbH=0,r_ggH=0 --setPhysicsModelParameterRanges r_ggH=-1,1 --allPars
...
combineTool.py -M Impacts -d output/mssm_070617/cmb/ws.root -m 200 --redefineSignalPOIs r_ggH --allPars --exclude r_bbH -o impacts_ggH_200.json
