...
if [[ "$1" == "" ]]; then echo "usage: $0 model"; exit 1; fi;
  ...
  B1WW_RANGES="mu_XS_VBF_r_XS_ggF=-2,5:mu_XS_WH_r_XS_ggF=-2,10:mu_XS_ZH_r_XS_ggF=-2,20:mu_XS_ttH_r_XS_ggF=-2,10:mu_BR_ZZ_r_BR_WW=-2,5:mu_BR_bb_r_BR_WW=-2,5:mu_BR_tautau_r_BR_WW=-2,5:mu_BR_gamgam_r_BR_WW=-2,5:mu_XS_ggF_x_BR_WW=-2,5"
  ...
  B1ZZ_RANGES="mu_XS_VBF_r_XS_ggF=-2,5:mu_XS_WH_r_XS_ggF=-2,10:mu_XS_ZH_r_XS_ggF=-2,20:mu_XS_ttH_r_XS_ggF=-2,10:mu_BR_WW_r_BR_ZZ=-2,5:mu_BR_bb_r_BR_ZZ=-2,5:mu_BR_tautau_r_BR_ZZ=-2,5:mu_BR_gamgam_r_BR_ZZ=-2,5:mu_XS_ggF_x_BR_ZZ=-2,5"
case $WSP in
A1_mu) POIs="mu" ;
       POIsF=",${BRU}";
       POIsR="mu=0,2" ;;
...
A2) POIs="mu_V_r_F mu_F_gamgam mu_F_ZZ mu_F_WW mu_F_tautau mu_F_bb" ;
    ...
    POIsR="mu_V_r_F=0,3:mu_F_gamgam=0,5:mu_F_ZZ=0,5:mu_F_WW=0,5:mu_F_tautau=0,5:mu_F_bb=0,5" ;;
...
B1ZZ_TH)  POIs="${B1ZZ_POIS}" ;
          ...
          POIsR="${B1ZZ_RANGES}" ;
          POIsF=",${BRU},mu_XS7_r_XS8_VBF,mu_XS7_r_XS8_WH,mu_XS7_r_XS8_ZH,mu_XS7_r_XS8_ggF,mu_XS7_r_XS8_ttH";;
B1WW_P78) POIs="${B1WW_POIS} mu_XS7_r_XS8_VBF mu_XS7_r_XS8_WH mu_XS7_r_XS8_ZH mu_XS7_r_XS8_ggF mu_XS7_r_XS8_ttH" ;
          POIsR="${B1WW_RANGES}:mu_XS7_r_XS8_VBF=-5,5:mu_XS7_r_XS8_WH=-10,10:mu_XS7_r_XS8_ZH=-10,10:mu_XS7_r_XS8_ggF=-5,5:mu_XS7_r_XS8_ttH=-10,10" ;
          POIsF=",${THEORY}";;
B1ZZ_P78) POIs="${B1ZZ_POIS} mu_XS7_r_XS8_VBF mu_XS7_r_XS8_WH mu_XS7_r_XS8_ZH mu_XS7_r_XS8_ggF mu_XS7_r_XS8_ttH" ;
          POIsR="${B1ZZ_RANGES}:mu_XS7_r_XS8_VBF=-5,5:mu_XS7_r_XS8_WH=-10,10:mu_XS7_r_XS8_ZH=-10,10:mu_XS7_r_XS8_ggF=-5,5:mu_XS7_r_XS8_ttH=-10,10" ;
          POIsF=",${THEORY}";;
...
B2) POIs="mu_XS_ggF_x_BR_WW mu_XS_VBF_x_BR_tautau mu_XS_WH_r_XS_VBF mu_XS_ZH_r_XS_WH mu_XS_ttH_r_XS_ggF mu_BR_ZZ_r_BR_WW mu_BR_gamgam_r_BR_WW mu_BR_tautau_r_BR_WW mu_BR_bb_r_BR_tautau" ;
    POIsR="mu_XS_ggF_x_BR_WW=0,5:mu_XS_VBF_x_BR_tautau=0,5:mu_XS_WH_r_XS_VBF=0,30:mu_XS_ZH_r_XS_WH=0,20:mu_XS_ttH_r_XS_ggF=0,10:mu_BR_ZZ_r_BR_WW=0,5:mu_BR_gamgam_r_BR_WW=0,5:mu_BR_tautau_r_BR_WW=0,5:mu_BR_bb_r_BR_tautau=0,5" ;
    POIsF=",${THEORY},mu_XS7_r_XS8_VBF,mu_XS7_r_XS8_WH,mu_XS7_r_XS8_ZH,mu_XS7_r_XS8_ggF,mu_XS7_r_XS8_ttH";;
...
K3_2D) POIs="kappa_V,kappa_F" ;
       POIsR="kappa_V=0.4,1.8:kappa_F=0.4,1.8" ;;
K3_5D_2D) POIs="kappa_V_gamgam,kappa_F_gamgam kappa_V_WW,kappa_F_WW kappa_V_ZZ,kappa_F_ZZ kappa_V_tautau,kappa_F_tautau kappa_V_bb,kappa_F_bb" ;
    POIsF=",kappa_V,kappa_F" ;
    POIsR="kappa_V_gamgam=0.4,1.8:kappa_F_gamgam=0,3:kappa_V_WW=0.4,1.8:kappa_F_WW=0,3:kappa_V_ZZ=0.4,1.8:kappa_F_ZZ=0,3:kappa_V_tautau=0.4,1.8:kappa_F_tautau=0,3:kappa_V_bb=0.4,1.8:kappa_F_bb=0,3" ;;
K3_5D_2D_N) POIs="kappa_V_gamgam,kappa_F_gamgam kappa_V_WW,kappa_F_WW kappa_V_ZZ,kappa_F_ZZ kappa_V_tautau,kappa_F_tautau kappa_V_bb,kappa_F_bb" ;
    POIsF=",kappa_V,kappa_F" ;
    POIsR="kappa_V_gamgam=0.4,1.8:kappa_F_gamgam=-2.5,0:kappa_V_WW=0.4,1.8:kappa_F_WW=-2.5,0:kappa_V_ZZ=0.4,1.8:kappa_F_ZZ=-2.5,0:kappa_V_tautau=0.4,1.8:kappa_F_tautau=-2.5,0:kappa_V_bb=0.4,1.8:kappa_F_bb=0,2.5" ;;
# ---- FOR L1 ----
esac;
if [[ "$2" == "-r" ]]; then
