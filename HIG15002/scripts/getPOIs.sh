...
B1ZZ_TH)  POIs="${B1ZZ_POIS}" ;
          ...
          POIsR="${B1ZZ_RANGES}" ;
          POIsF=",${BRU},mu_XS7_r_XS8_VBF,mu_XS7_r_XS8_WH,mu_XS7_r_XS8_ZH,mu_XS7_r_XS8_ggF,mu_XS7_r_XS8_ttH";;
B1WW_P78) POIs="${B1WW_POIS} mu_XS7_r_XS8_VBF mu_XS7_r_XS8_ggF mu_XS7_r_XS8_ttH" ;
          ...
          POIsF=",${THEORY},mu_XS7_r_XS8_WH,mu_XS7_r_XS8_ZH";;
B1ZZ_P78) POIs="${B1ZZ_POIS} mu_XS7_r_XS8_VBF mu_XS7_r_XS8_ggF mu_XS7_r_XS8_ttH" ;
